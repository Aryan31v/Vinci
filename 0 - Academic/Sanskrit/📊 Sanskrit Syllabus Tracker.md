# 🧠 LEARNING: Sanskrit (NCISM AyUG-SN & AI)

> [!info] 📊 Progress Tracker
> | Field | Value |
> | :--- | :--- |
> | **Status** | 🟡 In Progress |
> | **Phase** | 🧱 Foundation (Grammar) |
> | **Total Marks** | 0/300 (Theory + Viva) |
...
## 📅 TERM II
*Goal: Advanced Grammar and Medieval History*
...
| **Anvaya Writing (B)** | AH Su. 11-14 | ❌ | 5 | 10 | ⚪ | |
| **Itihas (4-7)** | Medieval | 1 | ❌ | ❌ | ⚪ | |

---

## 📅 TERM III
*Goal: Application, Panchatantra, and Modern Era*

| Topic | Category | MCQ | SAQ | LAQ | Status | Note Link |
| :--- | :--- | :---: | :---: | :---: | :--- | :--- |
| **4. Avyaya (Part C)** | Indeclinables | ❌ | 5 | ❌ | ⚪ | |
| **5. Karaka (Part C, D)** | Case Syntax | 1 | 5 | 10 | ⚪ | |
| **Nirukti / Paribhasha (C)**| Medical Terms| ❌ | 5 | 10 | ⚪ | |
| **Anvaya (C) / Subhashita**| Application | ❌ | 5 | 10 | ⚪ | |
| **4. Panchatantra** | Literature | ❌ | 5 | 10 | ⚪ | |
| **Itihas (8-10)** | Modern Era | 1 | ❌ | ❌ | ⚪ | |

---

## 📝 ACTIVE SPRINT
> [!todo] 🎯 Target: Term I Grammar
> 1. Complete **Varna Parichaya** and **Shabdaroopa**.
> 2. Study **Ayurved Itihas** (Origins to Bruhatrayee).
